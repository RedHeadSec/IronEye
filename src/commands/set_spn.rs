...
pub fn set_spn(
    ...
    let current_spns: Vec<String> = entry.attrs
    ...
    match action.to_lowercase().as_str() {
        ...
        "add" => {
            ...
            match ldap.modify(&target_dn, vec![Mod::Replace("servicePrincipalName", new_spns)]) {
        ...
        "del" | "delete" => {
            ...
            let new_spns: HashSet<&str> = current_spns.iter()
